...
for round in inp.split('\n'):
    points+=me.index(round.split()[1])+1
    points+=0 if ((me.index(round.split()[1])+1)%3)==elf.index(round.split()[0]) else 3 if me.index(round.split()[1])==elf.index(round.split()[0]) else 6
    pass
print(points)